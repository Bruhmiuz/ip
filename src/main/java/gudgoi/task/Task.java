...
// own file with a boolean `isMarked` field. The getTypeIcon hook and the
...
public abstract class Task {
     ...
     * <p>
     * Only a subclass can call this, because every real task is a todo, a
    ...
    public String toSaveFormat() {
        return this.getTypeLetter() + " | " + (this.isMarked ? "1" : "0")
    ...
    public String toString() {
        return this.getTypeIcon() + (this.isMarked ? "[X] " : "[ ] ") + this.description;
    }
}
